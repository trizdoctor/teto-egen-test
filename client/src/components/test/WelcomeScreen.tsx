      ...
      <div className="text-center mb-12">
        <div className="relative mb-8">
          <img
            ...
            className="rounded-2xl shadow-2xl mx-auto w-full max-w-2xl h-80 object-cover"
          />
        ...
        <Button
          ...
          size="lg"
          className="bg-gradient-teto-estrogen text-white px-12 py-4 text-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300 animate-bounce-subtle"
        >
